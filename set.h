...
public:
    ...
    set(InputerIterator first , InputerIterator last) : t(Compare()) {t.insert_unique(first , last);}

    template<class InputerIterator>
    set(InputerIterator first , InputerIterator last , const Compare& comp) : t(comp) {t.insert_unique(first , last);}
